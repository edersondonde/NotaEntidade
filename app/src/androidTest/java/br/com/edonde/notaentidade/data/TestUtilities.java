...
import br.com.edonde.notaentidade.utils.PollingCheck;
...
public class TestUtilities extends AndroidTestCase {
    ...
    static void validateCurrentRecord(String error, Cursor valueCursor, ContentValues expectedValues) {
        ...
        for (Map.Entry<String, Object> entry : valueSet) {
            ...
            Log.d("TestProvider", columnName+" "+entry.getValue().toString());
        }
    }

    public static ContentValues createNotaFiscalValues() {
        ContentValues notaFiscalValues = new ContentValues();
        notaFiscalValues.put(NotaFiscalEntry.COLUMN_CODE, "35150711514626000132590000025450008287018490");
